...
const SearchField = () => {
  return (
    <div className="flex items-center py-2 pl-4 ml-3 space-x-2 ">
      <div className="flex items-center px-1 py-1 space-x-4 bg-pink-100 rounded-full l">
        <FaSearch
      ...
      <div className="flex items-center px-4 py-1 space-x-4 bg-pink-100 rounded-full ">
